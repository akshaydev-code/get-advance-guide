                ...
                <div className="max-w-7xl mx-auto px-6 py-16 grid lg:grid-cols-5 gap-10">
                    <div>
                        ...
                        <p className="leading-8 text-violet-100">
                            Empowering students and professionals by connecting
                            them with the right mentors for guidance, growth,
                            and success.
                        </p>
                    </div>
                        ...
                        <div className="flex items-center gap-4">
                            {[FaFacebookF, FaTwitter, FaLinkedinIn, FaInstagram].map(
                                (Icon, index) => (
                                    <div
                                        key={index}
                                        className="w-12 h-12 rounded-full bg-white text-violet-600 flex items-center justify-center"
                                    >
                                        <Icon size={20} />
                                    </div>
                                )
